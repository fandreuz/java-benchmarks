...
public class CollectionBoxingSynchronizationBenchmark {
    ...
    public static class BenchmarkState extends Utils.AbstractBenchmarkState {
        ...
        public MutableObjectIntMap<String> primitiveMap = new SynchronizedObjectIntMap<>(ObjectIntMaps.mutable.empty());
